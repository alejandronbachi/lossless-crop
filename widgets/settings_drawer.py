...
class SettingsDrawer(
    ...
    def _build_ui(self):
        ...
        lbl_auto_section = QLabel(
            ui_constants.translate_constant(ui_constants.LABEL_GENERAL_SECTION)
        )
        ...
        self.main_app.cfg_remember_settings = SlidingSwitch(
            ui_constants.translate_constant(ui_constants.CHECKBOX_SAVE_SETTINGS_TEXT)
        )
        ...
        self.main_app.cfg_auto_folder = SlidingSwitch(
            ui_constants.translate_constant(ui_constants.CHECKBOX_AUTO_OPEN_FOLDER_TEXT)
        )
        ...
        self.main_app.cfg_fit_preview = SlidingSwitch(
            ui_constants.translate_constant(ui_constants.CHECKBOX_FIT_PREVIEW_TEXT)
        )
        ...
        self.main_app.cfg_dark_theme = SlidingSwitch(
            ui_constants.translate_constant(ui_constants.CHECKBOX_DARK_THEME)
        )
        ...
        lbl_show_section = QLabel(
            ui_constants.translate_constant(ui_constants.LABEL_SHOW_SECTION)
        )
        ...
        self.main_app.cfg_show_shortcuts = SlidingSwitch(
            ui_constants.translate_constant(ui_constants.CHECKBOX_SHORTCUTS_GUIDE_TEXT)
        )
        ...
        self.main_app.cfg_show_toasts = SlidingSwitch(
            ui_constants.translate_constant(ui_constants.CHECKBOX_NOTIFICATIONS_TEXT)
        )
        ...
        self.main_app.cfg_show_infobar = SlidingSwitch(
            ui_constants.translate_constant(ui_constants.CHECKBOX_BOTTOM_INFOBAR_TEXT)
        )
        ...
        self.main_app.cfg_show_directory = SlidingSwitch(
            ui_constants.translate_constant(ui_constants.CHECKBOX_IMAGE_DIRECTORY_TEXT)
        )
        ...
        self.main_app.cfg_show_filename = SlidingSwitch(
            ui_constants.translate_constant(ui_constants.CHECKBOX_IMAGE_FILENAME_TEXT)
        )
        ...
        self.main_app.cfg_show_imgsize = SlidingSwitch(
            ui_constants.translate_constant(ui_constants.CHECKBOX_IMAGE_RESOLUTION_TEXT)
        )
        ...
        self.main_app.cfg_show_preview = SlidingSwitch(
            ui_constants.translate_constant(ui_constants.CHECKBOX_PREVIEW_TEXT)
        )
        self.main_app.cfg_show_preview.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        self.main_app.cfg_show_preview.setToolTip(
            ui_constants.translate_constant(ui_constants.TOOLTIP_PREVIEW)
        )
        ...
        lbl_layout_section = QLabel(
            ui_constants.translate_constant(ui_constants.LABEL_LAYOUT_SECTION)
        )
        ...
        self.main_app.cfg_persist_main_win = SlidingSwitch(
            ui_constants.translate_constant(ui_constants.CHECKBOX_MAIN_WINDOW_TEXT)
        )
        ...
        self.main_app.cfg_persist_hud_win = SlidingSwitch(
            ui_constants.translate_constant(ui_constants.CHECKBOX_PREVIEW_HUD_TEXT)
        )
